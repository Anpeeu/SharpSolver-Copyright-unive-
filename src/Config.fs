...
let prefix_max_len = 11

let exit_text = "quitting..."

//array contenente i valori da stampare durante il comando #settings
let impostazioniTesto = [|
    "redux"
    "norm"
    "derivate"
    "integral"
...
CREDITS
%s
Project modified by Andrea Penzo
...
INTEGRAL 
I[x2 - x + 2]               this integrate the inner polynomial and produces the normalized polynomial as result
I[x2 - x + 2] = 2x - 2      integration occurs before normalization, making this a degree+1 equation
I[x3 - 2x2] = D[x4 + 3]     both hands of an equation may contain integrals
I[I[I[x3 - x2]]] = I[I[x4]] the integrate operator can be recursive
...
#settings               show or hide program outputs (1 show 0 hide)
#clear                  clear screen
#plot                   change plot settings (precision and  )
""" <| credits
